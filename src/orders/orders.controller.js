...
// order validation; needed for read(), update(), and destroy()
...
// Id validation needed for update()
...
// status validation needed for update()
...
// validation needed for create() and update()
...
// update an existing order if valid request
